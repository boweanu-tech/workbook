...
\QQRow{$x=6$ のとき $y=72$}{$a=2$}{$x=-2$ のとき $y=-1$}{$a=-\dfrac{1}{4}$}
...
\QQRow{$x=-2$ のとき $y=-12$}{$y=-3x^2$}{$x=-4$ のとき $y=4$}{$y=\dfrac{1}{4}x^2$}%答えだけが分数になるように。
\QQRow{$x=5$ のとき $y=-10$}{$y=-\dfrac{2}{5}x^2$}{$x=-6$ のとき $y=108$}{$y=3x^2$}%答えだけが分数になるように。
...
\QQ{$x=3$ のとき $y=27$ である。$y=12$ のときの $x$の値を求めなさい。}{$x=\pm 2$}
\QQ{$x=-4$ のとき $y=-9$ である。$y=-4$ のときの $x$の値を求めなさい。}{$x=\pm\dfrac{8}{3}$}
