...
\QQRow{$2\sin\theta+1=0$}{$\dfrac{7\pi}{6},\ \dfrac{11\pi}{6}$}{$2\cos\theta-3=0$}{解なし}
\QQRow{$\sqrt{3}\tan\theta-1=0$}{$\dfrac{\pi}{6},\ \dfrac{7\pi}{6}$}{$2\cos\theta+\sqrt{2}=0$}{$\dfrac{3\pi}{4},\ \dfrac{5\pi}{4}$}
...
\QQRow{$3\sin^2\theta+\cos^2\theta=2$}{\AnswerTwoLines{$\dfrac{\pi}{4},\ \dfrac{3\pi}{4}$}{$\dfrac{5\pi}{4},\ \dfrac{7\pi}{4}$}}{$1+\tan^2\theta=4$}{\AnswerTwoLines{$\dfrac{\pi}{3},\ \dfrac{2\pi}{3}$}{$\dfrac{4\pi}{3},\ \dfrac{5\pi}{3}$}}
\QQRow{$\dfrac{1}{\cos^2\theta}=2$}{\AnswerTwoLines{$\dfrac{\pi}{4},\ \dfrac{3\pi}{4}$}{$\dfrac{5\pi}{4},\ \dfrac{7\pi}{4}$}}{$\dfrac{\sin^2\theta}{\cos^2\theta}=\dfrac{1}{3}$}{\AnswerTwoLines{$\dfrac{\pi}{6},\ \dfrac{5\pi}{6}$}{$\dfrac{7\pi}{6},\ \dfrac{11\pi}{6}$}}
