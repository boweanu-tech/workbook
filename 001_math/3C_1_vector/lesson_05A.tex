...
%小問集合・・・
%(1)成分がわかっている２つのベクトルa,bに対し、p=a+tbとし、pとaが垂直なtをもとめる。
%(2)a,bの大きさがわかっていて、2a+3b,a-bが垂直であるとわかっている。このときのa,bのなす角をもとめる。
%(3)a,bの大きさ・内積がわかっているとき、a+tbの大きさの最小値とそのときのtをもとめる。

%三角形の面積に関する問題を追加。次の３点を頂点(座標を明示)とする、三角形の面積
%小問で4つほど。(1) (2)は図を書けば辺の一つが軸と平行になるように。
