...
\TypeQuestionSingle{数の形や計算の順序を工夫して、次の計算をしなさい。筆算を使わず、途中の計算も書きなさい。}{keisan_kufuu}
...
\TypeQuestionSingle{約分や数の組合せを工夫して、次の計算をしなさい。途中の計算も書きなさい。}{yakubun}
...
\QQRow{$10^4\times10^{-7}$}{}{$\dfrac{1}{10^{-5}}$}{}
\QQRow{$10^8\div10^3$}{}{$10^{-2}\div10^4$}{}
\QQRow{$\left(10^3\right)^{-2}$}{}{$\left(10^{-2}\right)^3$}{}

\TypeQuestionSingle{次の数を、$a\times10^n$（$1\leqq a<10$、$n$ は整数）の形で表しなさい。}{shisuu_hyouji}
\QQRow{$0.00045$}{}{$7280000$}{}
\QQRow{$0.031$}{}{$600$}{}
\QQRow{$0.0000072$}{}{$305000$}{}
\QQRow{$45.6\times10^3$}{}{$0.082\times10^{-4}$}{}

\TypeQuestionSingle{次の計算をし、答えを $a\times10^n$（$1\leqq a<10$、$n$ は整数）の形で表しなさい。}{shisuu_keisan}
