...
\QQ{$F=ma$ に、$F=8.0\times10^5$、$a=4.0\times10^2$ を代入し、$m$ を求める。}{}
...
\QQ{$F_1+F_2=ma$ に、$F_1=1.5\times10^4$、$m=4.0\times10^2$、$a=5.0\times10^1$ を代入し、$F_2$ を求める。}{}
\QQ{$m_1v_1=m_2v_2$ に、$m_1=2.0\times10^{-3}$、$v_1=6.0\times10^2$、$m_2=3.0\times10^{-2}$ を代入し、$v_2$ を求める。}{}
