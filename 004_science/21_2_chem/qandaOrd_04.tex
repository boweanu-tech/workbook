...
\Instruction{温度による物質の変化に関する次の問いに答えなさい。}
...
\Instruction{液体を成分ごとに分ける操作に関する次の問いに答えなさい。}
...
\QQ{液体を加熱するとき、急な沸騰を防ぐために入れるものを何というか。}{沸騰石}%別の問題に変えて下さい。沸騰石を答えさせる問題に
\QQ{水とエタノールの混合物を蒸留したとき、はじめに得られる液体に多く含まれる物質は何か。}{エタノール}
