...
\Instruction{集め方と空気に関する次の問いに答えなさい。}
...
\Instruction{ある気体の性質とつくり方に関する次の問いに答えなさい。}
\QQ{\RefBlank{oxygen}がもつ、ものを燃やすはたらきを何というか。}{助燃性}
\QQ{過酸化水素水に加える黒色の物質を\NamedBlank{manganese_dioxide}という。}{二酸化マンガン}%ブランクに
\QQ{過酸化水素水の市販名を何というか。}{オキシドール}
\QQ{黄緑色で刺激臭があり、漂白・殺菌作用をもつ気体は何か。}{塩素}%中学範囲で聞いたことがないので別のに変えて下さい。答えは酸素以外
\QQ{\RefBlank{oxygen}はどの方法で集めるか。}{水上置換法}

\Instruction{燃焼や実験で生じるものに関する次の問いに答えなさい。}
...
\Instruction{代表的な二つの気体に関する次の問いに答えなさい。}
