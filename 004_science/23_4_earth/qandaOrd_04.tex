...
\Instruction{月の特徴と運動に関する次の問いに答えなさい。}
...
\QQ{月が地球のまわりを1回\RefBlank{moon_revolution}する期間はどのくらいか。}{約27.3日}
\QQ{月が\RefBlank{moon_revolution}と同じ周期で自ら回転することを何というか。}{自転}

\Instruction{月の見え方に関する次の問いに答えなさい。}
\QQ{月は\RefBlank{moon_revolution}と同じ周期で自ら回転するため、地球からは月のどの面が見えるか。}{同じ面}
\QQ{月が1日に1回、東から西へ動くように見える運動を\NamedBlank{moon_diurnal}という。}{日周運動}
\QQ{同じ時刻に見える月の位置は、毎日少しずつどちらからどちらへ移るか。}{西から東}
\QQ{月が同じ位置に見える時刻は、毎日約何分ずつ遅くなるか。}{約50分}
\QQ{月の見かけの形が変化することを\NamedBlank{moon_phase}という。}{満ち欠け}

\Instruction{月の満ち欠けに関する次の問いに答えなさい。}
...
\QQ{\RefBlank{new_moon}から次の\RefBlank{new_moon}までの期間は約何日か。}{約29.5日}

\Instruction{日食・月食と惑星の見え方に関する次の問いに答えなさい。}
