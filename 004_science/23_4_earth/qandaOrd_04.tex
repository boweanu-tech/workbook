...
\QQ{月が地球のまわりを1回\RefBlank{moon_revolution}する期間はどのくらいか。}{約30日}
...
\QQ{月の\NamedBlank{moon_diurnal}では、地球から見て月はどちらからどちらへ動いていくように見えるか。}{東から西}
\QQ{同じ時刻に見える月の位置は、毎日少しずつどちらからどちらへ移るか。}{西から東}
\QQ{月の見かけの形が変化することを\NamedBlank{moon_phase}という。}{満ち欠け}
\QQ{月の光は、何の光が反射されたものか。}{太陽}

\Instruction{月の\RefBlank{moon_phase}に関する次の問いに答えなさい。}
...
\QQ{\NamedBlank{new_moon}から次の\NamedBlank{new_moon}までの期間は約何日か。}{約30日}
