...
\QQ{28.8mを6.0秒で進んだ物体の平均の\RefBlank{speed}は何m/sか。}{}
\QQ{\RefBlank{speed}が1.8m/sの物体が4.5秒間に進む距離は何mか。}{}
...
\QQ{0.2秒で42cm進んだ物体の\RefBlank{speed}は何m/sか。}{}
\QQ{\RefBlank{record_timer}で記録したテープの打点間隔が広くなると、物体の\RefBlank{speed}はどうなるか。}{}
...
\QQ{斜面を下る物体の\RefBlank{speed}は、一定の割合でどうなるか。}{}
\QQ{斜面の角度が大きいほど、斜面を下る物体の\RefBlank{speed}の増え方はどうなるか。}{}
\QQ{運動の向きと逆向きに一定の力がはたらくと、物体の\RefBlank{speed}は一定の割合でどうなるか。}{}
