...
\QQ{塩化ナトリウムの\RefBlank{ionization}の様子を、化学反応式で表しなさい。}{$\mathrm{NaCl \rightarrow Na^+ + Cl^-}$}
...
\QQ{塩化銅の\RefBlank{ionization}を、化学反応式で表しなさい。}{$\mathrm{CuCl_2 \rightarrow Cu^{2+} + 2Cl^-}$}
