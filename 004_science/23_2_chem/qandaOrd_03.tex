...
\Instruction{電池の基本に関する次の問いに答えなさい。}
...
\Instruction{イオンへのなりやすさに関する次の問いに答えなさい。}
...
\QQ{2種類の金属を用いた電池では、\RefBlank{ionization_tendency}が大きい金属が何極になるか。}{負極}

\Instruction{ボルタ電池に関する次の問いに答えなさい。}
...
\Instruction{ダニエル電池といろいろな電池に関する次の問いに答えなさい。}
